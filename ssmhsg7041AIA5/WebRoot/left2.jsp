	...
	<tr>
		<td ><table width="184"  border="0" cellpadding="0" cellspacing="0"  id="__01">
		 ...
		 <tr>
              ...
              <tr onClick="show('1')" style="cursor:pointer;">
                <td width="184"  background="images/hsg4.gif"><table width="100%" height="26" border="0" cellpadding="0" cellspacing="0">
                   <tr>
                      ...
                      <td width="86%" height="25"><span class="STYLE3"><strong>我的资料管理</strong></span></td>
                    </tr>
                </table></td>
              </tr>
              <tr>
				...
				<table width="91%" border="0" align="center" cellpadding="0" cellspacing="0">
					...
					<tr>
					 <td width="36" height="22" align="center"><img src="images/hsg5.gif"></td>
					  <td ><a href="doUpdateYonghuzhuce2.do" target="mainFrame">我的资料管理</a></td>
					</tr>
				  </table>				 </td>
              </tr>
          ...
          <tr>
            <td><table id="__01" width="184" border="0" cellpadding="0" cellspacing="0">
              <tr onClick="show('12')" style="cursor:pointer;">
                <td width="184" background="images/hsg4.gif"><table width="100%" height="26" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="14%"  height="26" align="center" valign="bottom">&nbsp;</td>
                      <td width="86%"><span class="STYLE3"><strong>我的商品发布</strong></span></td>
                    </tr>
                </table></td>
              </tr>
              <tr>
                <td width="184"  style="display:none"  id="show12"><table width="91%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="36" height="22" align="center"><img src="images/hsg5.gif"></td>
                      <td ><a href="shangpinxinxi_add.jsp" target="mainFrame">商品发布</a></td>
                    </tr>
                    <tr>
                      <td width="36" height="22" align="center"><img src="images/hsg5.gif"></td>
                      <td ><a href="shangpinxinxiList2.do" target="mainFrame">商品查询</a></td>
                    </tr>
                </table></td>
              </tr>
          ...
          <tr>
            ...
            <tr>
            <td><table id="__01" width="184" border="0" cellpadding="0" cellspacing="0">
              <tr onClick="show('22')" style="cursor:pointer;">
                <td width="184" background="images/hsg4.gif"><table width="100%" height="26" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="14%"  height="26" align="center" valign="bottom">&nbsp;</td>
                      <td width="86%"><span class="STYLE3"><strong>我的出售</strong></span></td>
                    </tr>
                </table></td>
              </tr>
              <tr>
                <td width="184"  style="display:none"  id="show22"><table width="91%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="36" height="22" align="center"><img src="images/hsg5.gif"></td>
                      <td ><a href="goumaijiluList3.do" target="mainFrame">我的出售</a></td>
                    </tr>
