...
<form action="addGoumaijilu.do" name="form1" method="post">
		...
		<tr ><td width="200">发布人：</td><td><input name='faburen' type='text' id='faburen' value='' onblur='' style='border:solid 1px #000000; color:#666666'  readonly='readonly' /></td></tr><script language="javascript">document.form1.faburen.value='<%=connDbBean.readzd("shangpinxinxi","faburen","id",request.getParameter("id"))%>';document.form1.faburen.setAttribute("readOnly",'true');</script>
