		   ...
		   <div class="nav-bd">
			   ...
			   <ul class="login">
				 <li class="login_no-bg">
					  你好<%=request.getSession().getAttribute("username")%>，欢迎来到小型电子商务网站！
					   <%
    ...
    <div class="menu">
      ...
      <a href="index.do">
       <div class="qtimages-img">
	      ...
	      <div  class="zhuxuewang"  >小型电子商务网站</div>
	   </div>
      </a>
      </div>
		    ...
		    <li class="drop-menu-effect"><a href="xwtzList.do?lb=站内新闻"><span>站内新闻</span></a> </li>
            ...
            <li class="drop-menu-effect"><a><span>在线投诉</span></a>
              <ul class="submenu">
                <li><a href="lyb.jsp">我要投诉</a></li>
                <li><a href="lybList.do">查看投诉</a></li>
               
              </ul>
            </li>
              
           
            <li class="drop-menu-effect"><a href="login.jsp"><span>后台管理</span></a>
